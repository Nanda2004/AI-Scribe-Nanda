...
def main():
    ...
    st.markdown(
        """
        <style>
        .note-card{padding:16px;border:1px solid #e5e7eb;border-radius:10px;background:#f8fafc}
        .section-header{font-weight:700; margin: 8px 0 4px 0}
        .pill{display:inline-block;padding:2px 8px;border:1px solid #3b82f6;border-radius:999px;color:#1e3a8a;font-weight:600;background:#eff6ff}
